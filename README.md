...
- You will need FFMPEG installed for the bot to speak in discord. [https://ffmpeg.org/](ffmpeg)
...
- You'll need to install torch for your PC. I tested with cuda 11.8. [https://pytorch.org/get-started/locally/](PyTorch)
...
- Create a discord bot using the Discord Developer Portal and add the bot the server you want the bot in. Permissions (I believe) needed are Read Messages, Speak, Connect. [https://discord.com/developers](Discord Dev)
